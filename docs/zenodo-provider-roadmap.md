...
| 3 | [#104 REST client](https://github.com/edithatogo/osf-cli-go/issues/104), `conductor/archive/zenodo-readonly-client_20260715/`; [#107 OAI-PMH](https://github.com/edithatogo/osf-cli-go/issues/107), `conductor/tracks/zenodo-oai-pmh_20260715/` | Independent read adapters pass offline contract, fuzz, limit, and redaction tests |
