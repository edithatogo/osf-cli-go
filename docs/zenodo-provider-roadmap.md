...
| 4 | [#105 CLI](https://github.com/edithatogo/osf-cli-go/issues/105), `conductor/archive/provider-scoped-cli_20260715/`; [#106 MCP](https://github.com/edithatogo/osf-cli-go/issues/106), `conductor/tracks/provider-scoped-mcp_20260715/` | Provider-scoped read UX is compatible and no deferred writes are advertised |
