...
- [~] Cross-platform release-candidate artifacts are generated by
  `.github/workflows/release-artifacts.yml`; a successful tag run is still
  required for dated independent verification.
