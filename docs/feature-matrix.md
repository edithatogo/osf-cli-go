...
| Storage integrity metadata | files list --json | optional attributes.extra.hashes.md5 | osf_files_list md5 | provider-supplied checksum only; no implicit download | implemented | Maintain checksum compatibility | `conductor/tracks/jasp-osf-integration-parity_20260711/spec.md` | #18 |
