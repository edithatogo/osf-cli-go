...
- [x] Task: Audit SourceShift/osf-mcp-server capabilities, activity, license, tests, release maturity, and user workflows
...
- [x] Task: Reconcile GitHub issue #8 with evidence and remaining external validation
