...
- [x] Task: Audit existing artifacts and identify gaps against a reproducible software or methods manuscript, comparative evaluation, internal review, venue selection, and explicit submission approval
...
- [x] Task: Reconcile GitHub issue #27, docs, and exact external status
