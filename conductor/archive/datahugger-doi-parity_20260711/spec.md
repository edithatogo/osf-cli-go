# Add DOI-oriented OSF retrieval parity with datahugger

## Overview

Evaluate [J535D165/datahugger](https://github.com/J535D165/datahugger) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#14](https://github.com/edithatogo/osf-cli-go/issues/14).
