...
- [x] Task: Audit scienceverse/metacheck capabilities, activity, license, tests, release maturity, and user workflows
...
- [x] Task: Reconcile GitHub issue #20 with evidence and remaining external validation
