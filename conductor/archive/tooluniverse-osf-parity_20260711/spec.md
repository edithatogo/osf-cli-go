# Add ToolUniverse-compatible OSF preprint and agent tooling

## Overview

Evaluate [mims-harvard/ToolUniverse](https://github.com/mims-harvard/ToolUniverse) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#15](https://github.com/edithatogo/osf-cli-go/issues/15).
