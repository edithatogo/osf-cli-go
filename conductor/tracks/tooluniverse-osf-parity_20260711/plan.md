...
- [ ] Task: Audit mims-harvard/ToolUniverse capabilities, activity, license, tests, release maturity, and user workflows
...
- [ ] Task: Reconcile GitHub issue #15 with evidence and remaining external validation
