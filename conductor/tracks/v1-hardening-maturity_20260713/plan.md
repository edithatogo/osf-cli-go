...
- [x] Task: Freeze CLI JSON and MCP schemas and write migration fixtures
- [x] Task: Complete threat model, write approval model, secret-handling review, and support policy
- [x] Task: Conductor - Automated Review and Checkpoint 'Contract and threat model' (Protocol in workflow.md)
