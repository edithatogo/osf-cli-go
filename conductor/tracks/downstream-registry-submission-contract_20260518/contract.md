...
| Codex plugin | Registered | `plugins/codex-osf` and `.agents/plugins/marketplace.json` | Repo/local plugin install | `codex plugin marketplace add` accepted local marketplace |
