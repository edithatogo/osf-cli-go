# Add OSF research-output and preregistration validation workflows

## Overview

Evaluate [scienceverse/metacheck](https://github.com/scienceverse/metacheck) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#20](https://github.com/edithatogo/osf-cli-go/issues/20).
