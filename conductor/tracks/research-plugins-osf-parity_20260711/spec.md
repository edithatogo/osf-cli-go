# Add research-agent OSF discovery and full-text workflow parity

## Overview

Evaluate [wentorai/research-plugins](https://github.com/wentorai/research-plugins) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#16](https://github.com/edithatogo/osf-cli-go/issues/16).
