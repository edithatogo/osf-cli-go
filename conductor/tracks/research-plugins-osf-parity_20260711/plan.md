...
- [x] Task: Audit wentorai/research-plugins capabilities, activity, license, tests, release maturity, and user workflows
...
- [x] Task: Implement accepted capabilities using existing repository patterns (none identified)
    - [x] Preserve existing explicit OSF download and authentication behavior
    - [x] Existing preprint and file surfaces cover the accepted OSF scope; no new exposure warranted
...
- [x] Task: Reconcile GitHub issue #16 with evidence and remaining external validation
