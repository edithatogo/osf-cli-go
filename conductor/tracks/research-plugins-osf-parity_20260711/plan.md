...
- [ ] Task: Audit wentorai/research-plugins capabilities, activity, license, tests, release maturity, and user workflows
...
- [ ] Task: Reconcile GitHub issue #16 with evidence and remaining external validation
