...
- [ ] Task: Audit existing artifacts and identify gaps against Docker MCP Catalog, mcp.so, awesome-mcp-servers, PulseMCP, MCP.Directory, MCPize, and maintained equivalents
...
- [ ] Task: Reconcile GitHub issue #26, docs, and exact external status
