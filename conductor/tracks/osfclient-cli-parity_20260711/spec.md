# Benchmark osfclient CLI workflows and close usability gaps

## Overview

Evaluate [osfclient/osfclient](https://github.com/osfclient/osfclient) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#9](https://github.com/edithatogo/osf-cli-go/issues/9).
