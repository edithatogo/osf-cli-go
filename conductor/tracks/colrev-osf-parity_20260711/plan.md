...
- [x] Task: Audit CoLRev-Environment/colrev capabilities, activity, license, tests, release maturity, and user workflows
...
- [x] Task: Reconcile GitHub issue #17 with evidence and remaining external validation
