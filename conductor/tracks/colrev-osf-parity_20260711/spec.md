# Add OSF literature-review ingestion and metadata parity

## Overview

Evaluate [CoLRev-Environment/colrev](https://github.com/CoLRev-Environment/colrev) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#17](https://github.com/edithatogo/osf-cli-go/issues/17).
