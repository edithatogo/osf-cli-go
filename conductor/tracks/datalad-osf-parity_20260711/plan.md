...
- [ ] Task: Audit datalad/datalad-osf capabilities, activity, license, tests, release maturity, and user workflows
...
- [ ] Task: Reconcile GitHub issue #12 with evidence and remaining external validation
