...
- [ ] Task: Audit Lucy-Family-Institute/presqt capabilities, activity, license, tests, release maturity, and user workflows
...
- [ ] Task: Reconcile GitHub issue #19 with evidence and remaining external validation
