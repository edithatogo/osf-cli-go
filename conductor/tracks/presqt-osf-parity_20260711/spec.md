# Benchmark PresQT preservation and metadata-transfer workflows

## Overview

Evaluate [Lucy-Family-Institute/presqt](https://github.com/Lucy-Family-Institute/presqt) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#19](https://github.com/edithatogo/osf-cli-go/issues/19).
