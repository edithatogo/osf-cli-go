...
- [x] Task: Audit existing artifacts and identify gaps against Cursor, Cline, Roo Code, Windsurf, VS Code, Zed, and other maintained plugin or MCP surfaces
...
- [x] Task: Reconcile GitHub issue #25, docs, and exact external status
