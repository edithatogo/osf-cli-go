# Benchmark OSF Sync desktop synchronization semantics

## Overview

Evaluate [CenterForOpenScience/osf-sync](https://github.com/CenterForOpenScience/osf-sync) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#13](https://github.com/edithatogo/osf-cli-go/issues/13).
