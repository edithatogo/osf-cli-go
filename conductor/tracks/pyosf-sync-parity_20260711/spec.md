# Benchmark pyosf synchronization and project workflows

## Overview

Evaluate [psychopy/pyosf](https://github.com/psychopy/pyosf) as a current OSF tooling reference and ensure OSF CLI Go matches or exceeds every material, maintainable capability. Tracking issue: [#11](https://github.com/edithatogo/osf-cli-go/issues/11).
