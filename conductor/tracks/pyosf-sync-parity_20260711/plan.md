...
- [x] Task: Audit psychopy/pyosf capabilities, activity, license, tests, release maturity, and user workflows
...
- [x] Task: Implement accepted capabilities using existing repository patterns (existing explicit tree transfer covers the accepted one-shot scope)
    - [x] Preserve conservative write and authentication behavior
    - [x] No continuous sync CLI or MCP exposure warranted
...
- [x] Task: Reconcile GitHub issue #11 with evidence and remaining external validation
