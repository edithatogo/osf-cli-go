...
- [ ] Task: Audit psychopy/pyosf capabilities, activity, license, tests, release maturity, and user workflows
...
- [ ] Task: Reconcile GitHub issue #11 with evidence and remaining external validation
