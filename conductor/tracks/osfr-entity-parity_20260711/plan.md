...
- [x] Task: Audit ropensci/osfr capabilities, activity, license, tests, release maturity, and user workflows
...
- [x] Task: Implement accepted capabilities using existing repository patterns (existing node, component, contributor, file, auth, and write surfaces cover the accepted scope)
    - [x] Preserve conservative write and authentication behavior
    - [x] No additional CLI or MCP exposure warranted
...
- [x] Task: Reconcile GitHub issue #10 with evidence and remaining external validation
