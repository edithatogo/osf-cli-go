...
- [x] [multi-provider-release-integration](tracks/multi-provider-release-integration_20260715/spec.md) — Integrate provider validation into CI, releases, observability, and docs; subissue #111.
