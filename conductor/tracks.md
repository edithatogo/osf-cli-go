...
- [x] [claude-official-plugin-directory-adoption](tracks/claude-official-plugin-directory-adoption_20260706/spec.md) — Prepare and submit the OSF Claude plugin to the official Claude plugin directory.
...
- [ ] [feature-matrix](tracks/feature-matrix_20260713/spec.md) — Maintain a comprehensive CLI/API/MCP/distribution feature matrix; issue #51.
- [ ] [v1-hardening-maturity](tracks/v1-hardening-maturity_20260713/spec.md) — Harden and mature the repository toward a defensible 1.0 launch; issue #52.
- [ ] [registry-submission-scorecard](tracks/registry-submission-scorecard_20260713/spec.md) — Maximize coding-agent and registry submission quality and scores; issue #53.
