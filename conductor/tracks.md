...
- [x] [cross-provider-provenance-transfer](tracks/cross-provider-provenance-transfer_20260715/spec.md) — Design explicit cross-provider copy with provenance and recovery; subissue #110.
