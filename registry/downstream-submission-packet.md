...
- Official package: `ghcr.io/edithatogo/osf-cli-go-osf-mcp:0.3.2`
- Go module: `github.com/edithatogo/osf-cli-go@v0.3.2`
...
```powershell
docker run --rm -i -e OSF_TOKEN ghcr.io/edithatogo/osf-cli-go-osf-mcp:0.3.2
```
...
```powershell
smithery mcp publish .\dist\mcpb\osf-cli-go-0.3.2-<runtime>.mcpb -n edithatogo/osf-cli-go
```
