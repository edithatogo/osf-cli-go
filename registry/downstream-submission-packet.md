...
- Official package: `ghcr.io/edithatogo/osf-cli-go-osf-mcp:0.2.0`
- Go module: `github.com/edithatogo/osf-cli-go@v0.2.0`
...
```powershell
go install github.com/edithatogo/osf-cli-go/cmd/osf-mcp@v0.2.0
```

Docker/OCI:

```powershell
docker run --rm -i -e OSF_TOKEN ghcr.io/edithatogo/osf-cli-go-osf-mcp:0.2.0
```
